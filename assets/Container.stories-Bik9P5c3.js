import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{A as r,t as i,u as a,w as o}from"./src-DMUTri94.js";var s,c,l,u,d,f,p,m;function h(){return(h=e((()=>{t(),i(),s=n(),c={title:`Components/Container`,component:o,tags:[`autodocs`],parameters:{docs:{description:{component:"A card-style layout wrapper rendered as a `<section>` element. It composes a header area (title, custom header, action slot), a main content area (`children`), and an optional footer. All slots are optional — include only what you need."}}},argTypes:{title:{control:`text`,description:"Heading text rendered in the header as an `<h2>` element"},children:{control:!1,description:`Main body content of the container`},action:{control:!1,description:`React node placed in the header action slot (right-aligned). Typically a button or link.`},header:{control:!1,description:`Custom header node that replaces or supplements the default title. Rendered between the title and the action slot.`},footer:{control:!1,description:`Footer content rendered below the main body, separated by a border`},className:{control:`text`,description:`Additional CSS class names for custom styling`}}},l={args:{title:`Container Title`},render:e=>(0,s.jsx)(o,{...e,children:(0,s.jsx)(`p`,{children:`This is the main content area of the container. Add any React content here.`})}),parameters:{docs:{description:{story:`A container with a title and simple text content. Use the Controls panel to change the title and explore other props.`}}}},u={name:`With Action`,render:()=>(0,s.jsx)(o,{title:`Latest Updates`,action:(0,s.jsx)(r,{size:`small`,mode:`outline`,children:`See all`}),children:(0,s.jsx)(`p`,{children:`Content with an action button in the header.`})}),parameters:{docs:{description:{story:'The `action` slot places a React node at the right edge of the header — ideal for "See all", "Edit", or settings buttons.'}}}},d={name:`With Custom Header`,render:()=>(0,s.jsx)(o,{title:`Profile Completion`,header:(0,s.jsxs)(`div`,{style:{fontSize:12,color:`#666`,marginBottom:4},children:[`Complete your profile to unlock all features`,(0,s.jsx)(a,{value:60,height:4,color:`main`})]}),children:(0,s.jsx)(`p`,{children:`The custom header is rendered between the title and the action slot.`})}),parameters:{docs:{description:{story:"Use the `header` prop to inject arbitrary content (e.g. a progress bar, subtitle, or status badge) into the header area alongside the title."}}}},f={name:`With Footer`,render:()=>(0,s.jsx)(o,{title:`Invoice #1042`,footer:(0,s.jsxs)(`div`,{style:{display:`flex`,justifyContent:`flex-end`,gap:8},children:[(0,s.jsx)(r,{mode:`outline`,size:`small`,children:`Cancel`}),(0,s.jsx)(r,{size:`small`,children:`Pay now`})]}),children:(0,s.jsx)(`p`,{children:`Invoice details and line items would go here.`})}),parameters:{docs:{description:{story:"The `footer` slot renders below the body, separated by a line — great for action bars with confirm/cancel buttons."}}}},p={name:`Full Example`,render:()=>(0,s.jsx)(o,{title:`User Registration`,action:(0,s.jsx)(r,{size:`small`,mode:`link`,children:`Need help?`}),header:(0,s.jsxs)(`div`,{style:{fontSize:12,color:`#666`},children:[`Fill in all required fields to create your account`,(0,s.jsx)(a,{value:40,height:3,color:`main`})]}),footer:(0,s.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`},children:[(0,s.jsx)(`span`,{style:{fontSize:13,color:`#666`},children:`Step 1 of 3`}),(0,s.jsx)(r,{children:`Continue`})]}),style:{maxWidth:500},children:(0,s.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12,padding:`8px 0`},children:(0,s.jsx)(`p`,{style:{margin:0},children:`Main form content goes here — inputs, selects, checkboxes, etc.`})})}),parameters:{docs:{description:{story:"A fully-composed example using all slots: `title`, `action`, `header` (with progress bar), body content, and `footer` (with step navigation)."}}}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...p.parameters?.docs?.source}}},m=[`Default`,`WithAction`,`WithCustomHeader`,`WithFooter`,`FullExample`]})))()}h();export{l as Default,p as FullExample,u as WithAction,d as WithCustomHeader,f as WithFooter,m as __namedExportsOrder,c as default};
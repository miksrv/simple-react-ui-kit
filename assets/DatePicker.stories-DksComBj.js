import{j as e}from"./index-Bp6KwiIU.js";import{r as m,R as u}from"./iframe-Ce9mQgAO.js";import{D as g}from"./Table-L-5-2ert.js";import"./index-CtZYqbhq.js";import"./preload-helper-PPVm8Dsz.js";const x={title:"Controls/DatePicker",component:g,argTypes:{locale:{control:{type:"select"},options:["en","ru"],table:{type:{summary:'"en", "ru"'}}},datePeriod:{control:"object",description:"Tuple of start and end dates (YYYY-MM-DD)"},minDate:{control:"text"},maxDate:{control:"text"},buttonMode:{control:{type:"select"},options:["primary","secondary","outline","link"],table:{type:{summary:'"primary", "secondary", "outline", "link"'}}},onDateSelect:{action:"date selected",table:{disable:!1}},onPeriodSelect:{action:"period selected",table:{disable:!1}},hidePresets:{control:"object",description:"List of preset options to hide"},periodDatesFormat:{control:"text",description:"Format for period range (default: DD.MM.YYYY)"},singleDateFormat:{control:"text",description:"Format for single date (default: DD MMMM YYYY)"},selectDateCaption:{control:"text",description:"Caption when no date is selected"},disabled:{control:"boolean"}}},o=d=>{const[i,c]=m.useState({});return e.jsxs("div",{style:{position:"relative",height:290},children:[e.jsx(g,{...d,onPeriodSelect:(l,p)=>c({start:l,end:p})}),e.jsxs("div",{style:{marginTop:16},children:[e.jsx("strong",{children:"Selected range:"})," ",i.start||"-"," — ",i.end||"-"]})]})},n=o.bind({});n.args={locale:"en",datePeriod:[new Date(Date.now()-8640*60*1e3).toISOString().slice(0,10),new Date().toISOString().slice(0,10)]};const t=o.bind({});t.args={locale:"en"};t.decorators=[()=>{const[d,i]=u.useState(void 0),c=l=>i(l);return e.jsxs("div",{style:{position:"relative",height:290},children:[e.jsx(g,{locale:"en",onDateSelect:c}),e.jsxs("div",{style:{marginTop:16},children:[e.jsx("strong",{children:"Selected date:"})," ",d||"-"]})]})}];const r=o.bind({});r.args={locale:"ru"};const a=o.bind({});a.args={minDate:"2024-06-01",maxDate:"2024-06-30"};const s=o.bind({});s.args={disabled:!0};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`args => {
...
}`,...s.parameters?.docs?.source}}};const b=["Default","DateSelect","RussianLocale","WithMinMax","Disabled"];export{t as DateSelect,n as Default,s as Disabled,r as RussianLocale,a as WithMinMax,b as __namedExportsOrder,x as default};

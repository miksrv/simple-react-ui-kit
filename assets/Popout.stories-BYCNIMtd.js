import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-BZJXY1be.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{A as i,S as a,t as o}from"./src-MvXUhqBh.js";var s,c,l,u,d,f,p,m,h,g;function _(){return(_=t((()=>{s=e(n(),1),o(),c=r(),l=()=>{let e=(0,s.useRef)(null);return(0,c.jsx)(`div`,{style:{minHeight:160,display:`flex`,justifyContent:`flex-end`},children:(0,c.jsx)(a,{ref:e,trigger:`Open Popout`,position:`right`,children:(0,c.jsxs)(`div`,{style:{padding:12,minWidth:200},children:[(0,c.jsx)(`p`,{style:{margin:`0 0 12px`},children:`Click the button below to close programmatically.`}),(0,c.jsx)(i,{onClick:()=>e.current?.close(),children:`Close via ref`})]})})})},u={title:`Components/Popout`,component:a,tags:[`autodocs`],parameters:{docs:{description:{component:"A dropdown popout that renders its content in a portal anchored to a trigger element. Supports left/right positioning, auto-close on child click, and imperative close via a forwarded `ref`. The trigger can be any React node or a plain string."}}},argTypes:{trigger:{control:`text`,description:`Content rendered as the clickable trigger — can be a string, button, or any React node`},position:{control:`inline-radio`,options:[`left`,`right`],description:`Anchors the popout to the left or right edge of the trigger element`,table:{defaultValue:{summary:`right`},type:{summary:`"left" | "right"`}}},disabled:{control:`boolean`,description:`Prevents the popout from opening when the trigger is clicked`,table:{defaultValue:{summary:`false`}}},closeOnChildrenClick:{control:`boolean`,description:`Automatically closes the popout when any child element inside it is clicked`,table:{defaultValue:{summary:`false`}}},children:{control:!1,description:`Content rendered inside the popout panel`},className:{control:`text`,description:`Additional CSS class names applied to the wrapper element`},onOpenChange:{control:!1,description:"Callback fired whenever the open state changes — receives `isOpen: boolean`"}}},d={render:e=>(0,c.jsx)(`div`,{style:{minHeight:160,display:`flex`,justifyContent:`flex-end`},children:(0,c.jsx)(a,{...e,children:(0,c.jsxs)(`div`,{style:{padding:12,minWidth:200},children:[(0,c.jsx)(`p`,{style:{margin:`0 0 8px`,fontWeight:600},children:`Popout Menu`}),(0,c.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:4},children:[(0,c.jsx)(i,{mode:`link`,children:`Profile`}),(0,c.jsx)(i,{mode:`link`,children:`Settings`}),(0,c.jsx)(i,{mode:`link`,variant:`negative`,children:`Sign out`})]})]})})}),args:{trigger:`Open Menu`,position:`right`},parameters:{docs:{description:{story:`Default right-anchored popout with a text trigger. Click the trigger to open/close the panel. Click outside to dismiss.`}}}},f={name:`Left Position`,render:()=>(0,c.jsx)(`div`,{style:{minHeight:160},children:(0,c.jsx)(a,{trigger:`Open (left)`,position:`left`,children:(0,c.jsxs)(`div`,{style:{padding:12,minWidth:180},children:[(0,c.jsx)(`p`,{style:{margin:`0 0 8px`,fontWeight:600},children:`Left-anchored`}),(0,c.jsx)(`p`,{style:{margin:0,fontSize:13,color:`#555`},children:`The panel aligns to the left edge of the trigger.`})]})})}),parameters:{docs:{description:{story:'With `position="left"` the popout panel aligns its left edge with the trigger element.'}}}},p={name:`Close on Child Click`,render:()=>(0,c.jsx)(`div`,{style:{minHeight:160,display:`flex`,justifyContent:`flex-end`},children:(0,c.jsx)(a,{trigger:(0,c.jsx)(i,{mode:`outline`,children:`Actions`}),position:`right`,closeOnChildrenClick:!0,children:(0,c.jsxs)(`div`,{style:{padding:8,minWidth:160},children:[(0,c.jsx)(i,{mode:`link`,onClick:()=>alert(`Edit clicked`),children:`Edit`}),(0,c.jsx)(i,{mode:`link`,onClick:()=>alert(`Duplicate clicked`),children:`Duplicate`}),(0,c.jsx)(i,{mode:`link`,variant:`negative`,onClick:()=>alert(`Delete clicked`),children:`Delete`})]})})}),parameters:{docs:{description:{story:"When `closeOnChildrenClick` is `true` the popout automatically closes whenever the user clicks any item inside it — ideal for action menus."}}}},m={name:`Imperative Close (via ref)`,render:()=>(0,c.jsx)(l,{}),parameters:{docs:{description:{story:"Use a forwarded `ref` (typed as `PopoutHandleProps`) to call `ref.current.close()` and dismiss the popout from within child content — useful when you need to close after an async action."}}}},h={name:`Button as Trigger`,render:()=>(0,c.jsx)(`div`,{style:{minHeight:160,display:`flex`,justifyContent:`flex-end`},children:(0,c.jsx)(a,{trigger:(0,c.jsx)(i,{icon:`VerticalDots`,"aria-label":`More options`}),position:`right`,children:(0,c.jsxs)(`div`,{style:{padding:8,minWidth:160},children:[(0,c.jsx)(i,{mode:`link`,children:`View details`}),(0,c.jsx)(i,{mode:`link`,children:`Edit`}),(0,c.jsx)(i,{mode:`link`,variant:`negative`,children:`Remove`})]})})}),parameters:{docs:{description:{story:"The `trigger` prop accepts any React node — here a three-dot icon button acts as the trigger for a context menu."}}}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
...
}`,...h.parameters?.docs?.source}}},g=[`Default`,`LeftPosition`,`WithCloseOnChildClick`,`ImperativeClose`,`WithButtonTrigger`]})))()}_();export{d as Default,m as ImperativeClose,f as LeftPosition,h as WithButtonTrigger,p as WithCloseOnChildClick,g as __namedExportsOrder,u as default};
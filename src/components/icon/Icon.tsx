...
export const Icon: React.FC<IconProps> = ({ name, ...props }) => {
    ...
    switch (name) {
        case 'AddressSign':
            ...
            break
        case 'ArrowUp':
            render = <path d='m5 9 1.41 1.41L11 5.83V22h2V5.83l4.59 4.59L19 9l-7-7z' />
            break
        case 'ArrowDown':
            render = <path d='m19 15-1.41-1.41L13 18.17V2h-2v16.17l-4.59-4.59L5 15l7 7z' />
            break
        case 'Map':
            render = (
            ...
            break
        case 'Menu':
            render = <path d='M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z' />
            break
        case 'Eye':
            render = (
        ...
        case 'Calendar':
            render = (
                <path d='M17 12h-5v5h5v-5zM16 1v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.88 2 1.99 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-1V1h-2zm3 18H5V8h14v11z' />
            )
            break
        case 'Photo':
            render = (
        ...
        case 'Lock':
            render = (
                <path d='M12 17c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2m6-9h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2M8.9 6c0-1.71 1.39-3.1 3.1-3.1s3.1 1.39 3.1 3.1v2H8.9zM18 20H6V10h12z' />
            )
            break
        case 'Award':
            render = (
            ...
            break
        case 'FullscreenIn':
            render = <path d='M7 14H5v5h5v-2H7zm-2-4h2V7h3V5H5zm12 7h-3v2h5v-5h-2zM14 5v2h3v3h2V5z' />
            break
        case 'FullscreenOut':
            render = <path d='M5 16h3v3h2v-5H5zm3-8H5v2h5V5H8zm6 11h2v-3h3v-2h-5zm2-11V5h-2v5h5V8z' />
            break
        case 'Layers':
            render = (
        ...
        case 'BarChart':
            ...
            break
        case 'KeyboardUp':
            render = <path d='M7.41 15.41 12 10.83l4.59 4.58L18 14l-6-6-6 6z' />
            break
        case 'KeyboardDown':
            render = <path d='M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6z' />
            break
        case 'KeyboardLeft':
            render = <path d='M15.41 16.59 10.83 12l4.58-4.59L14 6l-6 6 6 6 1.41-1.41z' />
            break
        case 'KeyboardRight':
            render = <path d='M8.59 16.59 13.17 12 8.59 7.41 10 6l6 6-6 6-1.41-1.41z' />
            break
        case 'Water':
            render = (
